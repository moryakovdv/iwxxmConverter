 ...
 *       &lt;sequence>
 *         &lt;element name="runway" type="{http://icao.int/iwxxm/2.0}RunwayDirectionPropertyType" minOccurs="0"/>
 *         &lt;element name="depositType" type="{http://icao.int/iwxxm/2.0}RunwayDepositsType" minOccurs="0"/>
 *         &lt;element name="contamination" type="{http://icao.int/iwxxm/2.0}RunwayContaminationType" minOccurs="0"/>
 *         &lt;element name="depthOfDeposit" type="{http://icao.int/iwxxm/2.0}DistanceWithNilReasonType" minOccurs="0"/>
 *         &lt;element name="estimatedSurfaceFrictionOrBrakingAction" type="{http://icao.int/iwxxm/2.0}RunwayFrictionCoefficientType" minOccurs="0"/>
 *       &lt;/sequence>
...
public class AerodromeRunwayStateType {
    ...
    @XmlElementRef(name = "depthOfDeposit", namespace = "http://icao.int/iwxxm/2.0", type = JAXBElement.class, required = false)
