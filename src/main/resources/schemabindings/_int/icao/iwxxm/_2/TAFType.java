 ...
 *         &lt;element name="previousReportAerodrome" type="{http://icao.int/iwxxm/2.0}AirportHeliportPropertyType" minOccurs="0"/>
 ...
 *       &lt;/sequence>
 *       &lt;attribute name="status" use="required" type="{http://icao.int/iwxxm/2.0}TAFReportStatusType" />
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
    ...
    extends ReportType
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "previousReportAerodrome", namespace = "http://icao.int/iwxxm/2.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "previousReportValidPeriod", namespace = "http://icao.int/iwxxm/2.0", type = JAXBElement.class, required = false),
        ...
        @XmlElementRef(name = "changeForecast", namespace = "http://icao.int/iwxxm/2.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "validTime", namespace = "http://icao.int/iwxxm/2.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "baseForecast", namespace = "http://icao.int/iwxxm/2.0", type = JAXBElement.class, required = false)
    })
     ...
     * line 60 of file:/home/moryakov/Development/workspace/tafconverter/src/test/resources/iwxxm/2.0/taf.xsd
