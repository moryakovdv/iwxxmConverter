...
public class PointArrayPropertyType {
    ...
    protected List<JAXBElement<? extends net.opengis.gml.v_3_2_1.PointType>> point;
     ...
     * 
     */
    public List<JAXBElement<? extends net.opengis.gml.v_3_2_1.PointType>> getPoint() {
        if (point == null) {
            point = new ArrayList<JAXBElement<? extends net.opengis.gml.v_3_2_1.PointType>>();
        }
        return this.point;
    }
