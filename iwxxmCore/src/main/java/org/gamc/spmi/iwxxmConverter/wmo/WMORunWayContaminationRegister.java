 ...
 * 
 * @author moryakov*/
public class WMORunWayContaminationRegister implements WMORegister<Integer> {

	private static final String registerFileName = "codes.wmo.int-bufr4-codeflag-0-20-087.rdf";
	
	ConcurrentHashMap<Integer, WMORegisterDescription> wmoContaminationCodes = new ConcurrentHashMap<Integer, WMORegisterDescription>();
	
	public WMORunWayContaminationRegister() {

	}

	private Locale locale = Locale.US;

	public WMORunWayContaminationRegister(Locale locale) {
		this.locale = locale;
	}
	...
	public void putToContent(String wmoCode, WMORegisterDescription description) {
		this.wmoContaminationCodes.put(Integer.valueOf(wmoCode), description);
	}
