...
/**Describes BECMG AT section in METAR*/
public class METARTimedATSection extends TacSectionImpl implements MetarForecastTimeSection {
	...
	public void parseSection() throws METARParsingException {
		...
		dtAT = parseSectionDateTimeToken(MetarParsingRegexp.metarBecomingTimestamp, innerTac.toString(), parentDateTime);
