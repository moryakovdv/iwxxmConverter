...
public class SigmetVolcanoPhenomenonDescription extends TacSectionImpl implements Serializable {
	public SigmetVolcanoPhenomenonDescription(String initialTacSection) {
	...
	private SigmetVolcanoForecastSection forecastSection;
	...
	public SigmetVolcanoForecastSection getForecastSection() {
		return forecastSection;
	}

	public void setForecastSection(SigmetVolcanoForecastSection forecastSection) {
