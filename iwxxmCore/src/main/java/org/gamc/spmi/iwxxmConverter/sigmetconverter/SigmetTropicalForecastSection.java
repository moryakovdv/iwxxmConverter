...
public class SigmetTropicalForecastSection extends TacSectionImpl implements Serializable {
	...
	public SigmetTropicalForecastSection(String initialTacSection) {
