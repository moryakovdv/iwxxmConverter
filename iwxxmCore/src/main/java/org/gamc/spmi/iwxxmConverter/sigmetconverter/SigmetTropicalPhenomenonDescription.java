...
public class SigmetTropicalPhenomenonDescription extends TacSectionImpl implements Serializable {
	public SigmetTropicalPhenomenonDescription(String initialTacSection) {
	...
	public enum Severity implements IwxxmEnum {
		ISOL("ISOL"), OBSC("OBSC"), SQL("SQL"), EMBD("EMBD"), FRQ("FRQ"), SEV("SEV"), HVY("HVY"), NOTSET("");
	...
	private SigmetTropicalForecastSection forecastSection;
	...
	public SigmetTropicalForecastSection getForecastSection() {
		return forecastSection;
	}

	public void setForecastSection(SigmetTropicalForecastSection forecastSection) {
