...
public class TAFTimedTLSection extends TacSectionImpl implements TafForecastTimeSection {
	...
	public TAFTimedTLSection(String initialTac,TacMessageImpl parent) {
	...
	public void parseSection() throws TAFParsingException {
		...
		dtTL = parseSectionDateTimeToken(TafParsingRegexp.tafBecomingTimestamp, innerTac.toString(), parentDateTime);
		/*
	...
	public Interval getTrendValidityInterval() {
		...
		return new Interval(getParentMessage().getValidityInterval().getStart(),dtTL);
	}
}
