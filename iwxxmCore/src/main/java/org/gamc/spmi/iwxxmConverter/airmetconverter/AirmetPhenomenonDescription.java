...
public class AirmetPhenomenonDescription extends TacSectionImpl implements Serializable {

	public AirmetPhenomenonDescription(String initialTacSection) {
	...
	private AirmetMovingSection movingSection;
	private AirmetForecastSection forecastSection;
	...
	public AirmetForecastSection getForecastSection() {
		return forecastSection;
	}

	public void setForecastSection(AirmetForecastSection forecastSection) {
	...
	public AirmetMovingSection getMovingSection() {
		return movingSection;
	}

	public void setMovingSection(AirmetMovingSection movingSection) {
