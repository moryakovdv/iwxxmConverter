 ...
 *         &lt;element name="surfaceWind" type="{http://icao.int/iwxxm/2.0}AerodromeSurfaceWindPropertyType"/>
 *         &lt;element name="visibility" type="{http://icao.int/iwxxm/2.0}AerodromeHorizontalVisibilityPropertyType" minOccurs="0"/>
 *         &lt;element name="rvr" type="{http://icao.int/iwxxm/2.0}AerodromeRunwayVisualRangePropertyType" maxOccurs="4" minOccurs="0"/>
 *         &lt;element name="presentWeather" type="{http://icao.int/iwxxm/2.0}AerodromePresentWeatherType" maxOccurs="3" minOccurs="0"/>
 *         &lt;element name="cloud" type="{http://icao.int/iwxxm/2.0}AerodromeObservedCloudsPropertyType" minOccurs="0"/>
 *         &lt;element name="recentWeather" type="{http://icao.int/iwxxm/2.0}AerodromeRecentWeatherType" maxOccurs="3" minOccurs="0"/>
 *         &lt;element name="windShear" type="{http://icao.int/iwxxm/2.0}AerodromeWindShearPropertyType" minOccurs="0"/>
 *         &lt;element name="seaState" type="{http://icao.int/iwxxm/2.0}AerodromeSeaStatePropertyType" minOccurs="0"/>
 *         &lt;element name="runwayState" type="{http://icao.int/iwxxm/2.0}AerodromeRunwayStatePropertyType" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends AbstractGMLType
{
    ...
    protected AerodromeObservedCloudsPropertyType cloud;
     ...
     * @return
     *     possible object is
     *     {@link AerodromeObservedCloudsPropertyType }
     *     
     */
    public AerodromeObservedCloudsPropertyType getCloud() {
        return cloud;
    }
     ...
     *     
     */
    public void setCloud(AerodromeObservedCloudsPropertyType value) {
        this.cloud = value;
    }
