...
@XmlSeeAlso({
    ...
    MeteorologicalPositionType.class,
    EvolvingMeteorologicalConditionType.class,
    VolcanicAshCloudType.class,
    AIRMETEvolvingMeteorologicalConditionType.class,
    VolcanicAshConditionsType.class,
    MeteorologicalPositionCollectionType.class,
    ReportType.class,
    ...
    extends AbstractGMLType
{
	...
	/**BoundedBy намеренно сделано необязательным*/
