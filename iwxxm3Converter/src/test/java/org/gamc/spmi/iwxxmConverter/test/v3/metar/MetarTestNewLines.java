...
public class MetarTestNewLines {
	...
	String npeMetarNoNewLine = "SPECI YUDO 151115Z 05025G37KT 3000 1200NE +TSRA BKN005CB 25/22 Q1008 TEMPO TL1200 0600\n" + 
			"BECMG AT1200 8000 NSW NSC";
	@Test
	public void testNullPointerWithNewLines() throws UnsupportedEncodingException, DatatypeConfigurationException, JAXBException, ParsingException, WMORegisterException {
	...
	@Test
	public void testNullPointerWithNoNewLines() throws UnsupportedEncodingException, DatatypeConfigurationException, JAXBException, ParsingException, WMORegisterException {
		SPECIConverterV3 cv = new SPECIConverterV3();
